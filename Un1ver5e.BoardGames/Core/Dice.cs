...
namespace Un1ver5e.BoardGames.Core
{
    /// <summary>
    ...
    public class Dice
    {
        ...
        private static Dictionary<string, Dice> Cache { get; } = new Dictionary<string, Dice>();
        ...
        {
            Cache["1d2"] = new Dice(2);
            Cache["1d3"] = new Dice(3);
            Cache["1d4"] = new Dice(4);
            Cache["1d6"] = new Dice(6);
            Cache["1d8"] = new Dice(8);
            Cache["1d10"] = new Dice(10);
            Cache["1d12"] = new Dice(12);
            Cache["1d20"] = new Dice(20);
            Cache["1d100"] = new Dice(100);
            Cache["2d6"] = new Dice(6, 2);
        }
